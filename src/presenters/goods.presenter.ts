...
class GoodsPresenterForMany implements IPresenter<IPaginationResponse<IGoodsForMany>, Partial<IPaginationResponse<IGoodsForMany>>> {
    present(data: IPaginationResponse<IGoodsForMany>): Partial<IPaginationResponse<IGoodsForMany>> {
        return {
            page: data.page,
            limit: data.limit,
