...
router.patch("/update", userAuthMidleware_1.authMiddlewareForCheck.checkRightsOfUser(users_rights_enum_1.ERights.Seller), auth_middleware_1.authMiddleware.checkAccessToken, user_controler_1.userController.Update);
